...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Основные стили', 'wp-bootstrap-starter' ),
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        ...
        'choices' => array(
            'default' => 'Default',
            'helvetica-nue' => 'Helvetica Nue / VM-theme',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Логотип заголовка', 'wp-bootstrap-starter' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_setting( 'header_banner_title_setting', array(
        'default' => __( 'Text white', 'wp-bootstrap-starter' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Другие настройки темы', 'wp-bootstrap-starter' ),
